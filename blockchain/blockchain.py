...
class Blockchain:
    ...
    def submit_transaction(self, sender_public_key, recipient_public_key, amount, signature):
        ...
        # Manages transactions from wallet to another wallet
            ...
            transaction_verification = self.verify_transaction_signature(sender_public_key, signature, transaction)
...
def new_transaction():
    values = request.form
    required = ['confirmation_sender_public_key', 'confirmation_receipent_public_key', 'confirmation_amount', 'transaction_signature']
    if not all(k in values for k in required):
        return 'Missing values', 400
    # Create a new Transaction
    transaction_result = blockchain.submit_transaction(values['confirmation_sender_public_key'], values['confirmation_receipent_public_key'],
                                                       values['confirmation_amount'], values['transaction_signature'])
